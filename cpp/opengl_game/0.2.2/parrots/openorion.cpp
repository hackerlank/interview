...
void PrintDebug()
{
	...
	TextOut(string(frames_per_second), DEBUG_FONT, &hDC, 5, 40);
...
void InitFonts()
{
	LoadFont("Times New Roman", &fonts[0], 14, FW_BOLD, "default"); // doesnt work
	LoadFont("Courier New", &fonts[1], 14, FW_NORMAL, "log_screen"); // doesnt work
...
void InitDefinitions()
{
	...
	gamedef.gui.LoadFromFile("def\\gui.def");
