...
void InitGUI()
{
	gamedef.gui.LoadFromFile("gui.txt");
	gui = new GUI();
	...
	//{
	//	i++;
	//	(*it)->SetTexture(TextureByName(textures, "button_long"));
	...
	//GUIcontrol* gamebutton = new GUIcontrol("Game");
	//GUIcontrol* designbutton = new GUIcontrol("Design");
	//GUIcontrol* fleetbutton = new GUIcontrol("Fleet");
	//GUIcontrol* mapbutton = new GUIcontrol("Map");
	//GUIcontrol* planetbutton = new GUIcontrol("Planets");
	//GUIcontrol* techbutton = new GUIcontrol("Tech");
	//GUIcontrol* turnbutton = new GUIcontrol("Next Turn");

	//gui->gamemenu->AddChild(gamebutton);
	//gui->gamemenu->AddChild(designbutton);
	//gui->gamemenu->AddChild(fleetbutton);
	//gui->gamemenu->AddChild(mapbutton);
	//gui->gamemenu->AddChild(planetbutton);
	//gui->gamemenu->AddChild(techbutton);
	//gui->gamemenu->AddChild(turnbutton);

	//i = -1;
	//for(std::vector<GUIcontrol*>::iterator it = gui->gamemenu->children.begin();
	//	it != gui->gamemenu->children.end();
	//	it++)
	//{
	//	i++;
	//	(*it)->SetTexture(TextureByName(textures, "game_button"));
	//	(*it)->SetPatternCount(1);
	//	(*it)->SetPatternWidth((*it)->tex->width);
	//	(*it)->SetPatternHeight((*it)->tex->height);
	//	(*it)->SetPos(i*(*it)->GetPatternWidth(), cfg.scr_height-(*it)->GetPatternHeight());
	//	(*it)->SetCurrentPattern(0);
	//	(*it)->SetVisible(false);
	//	(*it)->SetColor(255, 255, 255, 255);
