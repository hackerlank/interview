...
int GUIControl::GetData() { return data; }
...
void GUIControl::SetData(int new_data)
{ data = new_data; }
...
{
	messages->Add(msg);
	SetLastSentMsg(msg.a1);
}

void GUIControl::OnMouseMove()
{
	if(GetLastSentMsg() != MOUSE_MOVE)
	{
		GUIMessage msg;
