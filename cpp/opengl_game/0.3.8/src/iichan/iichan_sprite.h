...
// Для оптимизации вывода тайлов, все равно они статические
//#define USE_LISTS_FOR_TILESET
...
private:
	...
	bool visible;
#ifdef USE_LISTS_FOR_TILESET
	bool tile;
#endif

public:
#ifdef USE_LISTS_FOR_TILESET
	bool IsTile() const { return tile; }
	void SetTile(bool new_value) { tile = new_value; }
#endif
	...
	//Z_ORDER GetZ() const { return z; }
	void SetZ(int new_value) { z = new_value; }
	//void SetZ(Z_ORDER new_value) { z = new_value; }
	...
	void SetTexture(Texture* new_value) { tex = new_value; }
	...
	void SetRealWidth(int new_value)
	{
		realWidth = new_value; 
	}
	...
	void SetRealHeight(int new_value) 
	{
		realHeight = new_value; 
	}
