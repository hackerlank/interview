...
private:
	...
	float speedX;										// устаревшее
    float speedY;										// устаревшее

	int shootPattern;
	int shootCount;
	int shootAnimationSpeed;
	int shootAttackPattern;
	int jumpPattern;
	int jumpCount;
	int jumpDownPattern;
	...
	bool doneAnimation;
	bool jumpDirection;					// false - вверх
	...
	int realShootX;
	int realShootY;
	int realShootMirrorX;
	int realShootMirrorY;
	int realShootWidth;
	int realShootHeight;
...
public:
	...
	int GetRealShootX() const { return realShootX; }
	int GetRealShootY() const { return realShootY; }
	...
	int GetRealShootMirrorX() const { return realShootMirrorX; }
	int GetRealShootMirrorY() const { return realShootMirrorY; }
	...
	void SetRealShootX(int new_value) { realShootX = new_value; }
	void SetRealShootY(int new_value) { realShootY = new_value; }
	...
	void SetRealShootMirrorX(int new_value) { realShootMirrorX = new_value; }
	void SetRealShootMirrorY(int new_value) { realShootMirrorY = new_value; }
	...
	int GetRealShootWidth() const { return realShootWidth; }
	int GetRealShootHeight() const { return realShootHeight; }
	...
	void SetRealShootWidth(int new_value)  { realShootWidth = new_value; }
	void SetRealShootHeight(int new_value)  { realShootHeight = new_value; }
	...
	int GetYStart() const { return yStart; }									// устаревшее
	void SetYStart(int new_value) { yStart = new_value; }						// устаревшее

	float GetSpeedY() const { return speedY; }									// устаревшее
	void SetSpeedY(float new_value) { speedY = new_value; }						// устаревшее

	float GetSpeedX() const { return speedX; }									// устаревшее
	void SetSpeedX(float new_value) { speedX = new_value; }						// устаревшее
	...
	int GetShootAttackPattern() const { return shootAttackPattern; }
	void SetShootAttackPattern(int new_value) { shootAttackPattern = new_value; }
