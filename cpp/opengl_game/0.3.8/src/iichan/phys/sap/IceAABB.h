///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	Contains ASAP_AABB-related code. (axis-aligned bounding box)
 *	\file		IceAABB.h
...
#define ICEAABB_H
	...
	inline_ void ComputeMinMax(const ASAP_Point& p, ASAP_Point& min, ASAP_Point& max)
	{
...
#define AABB_COMMON_METHODS																											\
			ASAP_AABB&			Add(const ASAP_AABB& aabb);																					\
			ASAP_AABB&			Sub(const ASAP_AABB& aabb);																					\
			float			MakeCube(ASAP_AABB& cube)																			const;	\
			void			MakeSphere(Sphere& sphere)																		const;	\
			const sbyte*	ComputeOutline(const ASAP_Point& local_eye, sdword& num)												const;	\
			float			ComputeBoxArea(const ASAP_Point& eye, const Matrix4x4& mat, float width, float height, sdword& num)	const;	\
			bool			IsInside(const ASAP_AABB& box)																		const;	\
			bool			ComputePlanes(Plane* planes)																	const;	\
			bool			ComputePoints(ASAP_Point* pts)																		const;	\
			const ASAP_Point*	GetVertexNormals()																				const;	\
			const udword*	GetEdges()																						const;	\
			const ASAP_Point*	GetEdgeNormals()																				const;	\
	inline_	BOOL			ContainsPoint(const ASAP_Point& p)																	const	\
							{																										\
	...
	enum AABBType
	{
		AABB_RENDER			= 0,	//!< ASAP_AABB used for rendering. Not visible == not rendered.
		AABB_UPDATE			= 1,	//!< ASAP_AABB used for dynamic updates. Not visible == not updated.
	...
	class ICEMATHS_API ASAP_AABB : public Allocateable
	{
		public:
		//! Constructor
		inline_						ASAP_AABB()	{}
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 *	Setups an ASAP_AABB from min & max vectors.
		 *	\param		min			[in] the min point
		 *	\param		max			[in] the max point
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						void		SetMinMax(const ASAP_Point& min, const ASAP_Point& max)		{ mMin = min;		mMax = max;									}

		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 *	Setups an ASAP_AABB from center & extents vectors.
		 *	\param		c			[in] the center point
		 *	\param		e			[in] the extents vector
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						void		SetCenterExtents(const ASAP_Point& c, const ASAP_Point& e)	{ mMin = c - e;		mMax = c + e;								}

		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 *	Setups an empty ASAP_AABB.
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						void		SetEmpty()											{ ASAP_Point p(MIN_FLOAT, MIN_FLOAT, MIN_FLOAT);	mMin = -p; mMax = p;}

		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 *	Setups a point ASAP_AABB.
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						void		SetPoint(const ASAP_Point& pt)							{ mMin = mMax = pt;												}

		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 *	Gets the size of the ASAP_AABB. The size is defined as the longest extent.
		 *	\return		the size of the ASAP_AABB
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						float		GetSize()								const		{ ASAP_Point e; GetExtents(e);	return e.Max();	}

		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 *	Extends the ASAP_AABB.
		 *	\param		p	[in] the next point
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_			void		Extend(const ASAP_Point& p)								{ ComputeMinMax(p, mMin, mMax);				}

		// Data access

		//! Get min point of the box
		inline_			void		GetMin(ASAP_Point& min)						const		{ min = mMin;								}
		//! Get max point of the box
		inline_			void		GetMax(ASAP_Point& max)						const		{ max = mMax;								}
		...
		//! Get box center
		inline_			void		GetCenter(ASAP_Point& center)				const		{ center = (mMax + mMin)*0.5f;				}
		//! Get box extents
		inline_			void		GetExtents(ASAP_Point& extents)				const		{ extents = (mMax - mMin)*0.5f;				}
		...
		//! Get box diagonal
		inline_			void		GetDiagonal(ASAP_Point& diagonal)			const		{ diagonal = mMax - mMin;					}
		 ...
		 *	\param		a		[in] the other ASAP_AABB
		 *	\return		true on intersection
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_			BOOL		Intersect(const ASAP_AABB& a)				const
									{
										if(mMax.x < a.mMin.x
										|| a.mMax.x < mMin.x
										|| mMax.y < a.mMin.y
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_			BOOL		Intersect(const ASAP_AABB& a, udword axis)	const
									{
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 *	Recomputes the ASAP_AABB after an arbitrary transform by a 4x4 matrix.
		 *	Original code by Charles Bloom on the GD-Algorithm list. (I slightly modified it)
		 *	\param		mtx			[in] the transform matrix
		 *	\param		aabb		[out] the transformed ASAP_AABB [can be *this]
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_			void		Rotate(const Matrix4x4& mtx, ASAP_AABB& aabb)	const
									{
		...
		//! Operator for ASAP_AABB *= float. Scales the extents, keeps same center.
		inline_			ASAP_AABB&		operator*=(float s)
									{
										ASAP_Point Center;	GetCenter(Center);
										ASAP_Point Extents;	GetExtents(Extents);
		...
		//! Operator for ASAP_AABB += ASAP_Point. Translates the box.
		inline_			ASAP_AABB&		operator+=(const ASAP_Point& trans)
									{
										mMin+=trans;
										mMax+=trans;
										return *this;
		...
		private:
						ASAP_Point		mMin;			//!< Min point
						ASAP_Point		mMax;			//!< Max point
	};

#else

	class ICEMATHS_API ASAP_AABB
	{
		public:
		//! Constructor
		inline_						ASAP_AABB()	{}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						void		SetMinMax(const ASAP_Point& min, const ASAP_Point& max)		{ mCenter = (max + min)*0.5f; mExtents = (max - min)*0.5f;		}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						void		SetCenterExtents(const ASAP_Point& c, const ASAP_Point& e)	{ mCenter = c;	 mExtents = e;									}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						void		SetPoint(const ASAP_Point& pt)							{ mCenter = pt; mExtents.Zero();								}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						void		Extend(const ASAP_Point& p)
									{
										ASAP_Point Max = mCenter + mExtents;
										ASAP_Point Min = mCenter - mExtents;
		...
		//! Get min point of the box
		inline_			void		GetMin(ASAP_Point& min)						const		{ min = mCenter - mExtents;					}
		//! Get max point of the box
		inline_			void		GetMax(ASAP_Point& max)						const		{ max = mCenter + mExtents;					}
		...
		//! Get box center
		inline_			void		GetCenter(ASAP_Point& center)				const		{ center = mCenter;							}
		//! Get box extents
		inline_			void		GetExtents(ASAP_Point& extents)				const		{ extents = mExtents;						}
		...
		//! Get box diagonal
		inline_			void		GetDiagonal(ASAP_Point& diagonal)			const		{ diagonal = mExtents * 2.0f;				}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_			bool		GomezIntersect(const ASAP_AABB& a)
									{
										ASAP_Point	T = mCenter - a.mCenter;	// Vector from A to B
		...
		inline_			void		Rotate(const Matrix4x4& mtx, ASAP_AABB& aabb)	const
									{
										...
										ASAP_Point Ex(mtx.m[0][0] * mExtents.x, mtx.m[0][1] * mExtents.x, mtx.m[0][2] * mExtents.x);
										IR(Ex.x)&=0x7fffffff;	IR(Ex.y)&=0x7fffffff;	IR(Ex.z)&=0x7fffffff;

										ASAP_Point Ey(mtx.m[1][0] * mExtents.y, mtx.m[1][1] * mExtents.y, mtx.m[1][2] * mExtents.y);
										IR(Ey.x)&=0x7fffffff;	IR(Ey.y)&=0x7fffffff;	IR(Ey.z)&=0x7fffffff;

										ASAP_Point Ez(mtx.m[2][0] * mExtents.z, mtx.m[2][1] * mExtents.z, mtx.m[2][2] * mExtents.z);
		...
		//! Operator for ASAP_AABB *= float. Scales the extents, keeps same center.
		inline_			ASAP_AABB&		operator*=(float s)		{ mExtents*=s;	return *this;	}
		...
		private:
						ASAP_Point		mCenter;			//!< ASAP_AABB Center
						ASAP_Point		mExtents;			//!< x, y and z extents
	};

#endif

	//! Computes the ASAP_AABB around a set of vertices
	inline_ void ComputeAABB(ASAP_AABB& aabb, const ASAP_Point* list, udword nb_pts)
	{
		if(list)
		{
			ASAP_Point Maxi(MIN_FLOAT, MIN_FLOAT, MIN_FLOAT);
			ASAP_Point Mini(MAX_FLOAT, MAX_FLOAT, MAX_FLOAT);
			while(nb_pts--)
			{
//				_prefetch(list+1);	// off by one ?
	...
	//! Computes the ASAP_AABB around a set of vertices after transform by a matrix
	inline_ void ComputeAABB(ASAP_AABB& aabb, const ASAP_Point* list, udword nb_pts, const Matrix4x4& world)
	{
		if(list)
		{
			ASAP_Point Maxi(MIN_FLOAT, MIN_FLOAT, MIN_FLOAT);
