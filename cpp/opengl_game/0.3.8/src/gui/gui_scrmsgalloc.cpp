...
{
	static const Font* font = FontByName(LOG_SCREEN_FONT);
...
void GUIScreenMessageAllocator::Process()
{
	if(GetMessageCount() > 0)
	{
		tick2 = current_time - _startup_time;
