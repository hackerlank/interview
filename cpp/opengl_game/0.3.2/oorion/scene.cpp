...
void PrintDebug()
{
	...
	PrintText(clear, font, 5, 85);
	PrintText(mainloop, font, 5, 100);
	PrintText(draw, font, 5, 115);
	PrintText(flip, font, 5, 130);
#endif
#ifdef _DEBUG_GUI
...
//
//	PrintText(diff_pck, font, 5, 170);
//	PrintText(size_pck, font, 5, 185);
//	PrintText(race_pck, font, 5, 200);
//	PrintText(opp_pck, font, 5, 215);
//#endif
